...
class RepoStats(object):
    symbols = {
        ...
        'conflicted': u'\u2600',  # ☀    star
        'stash': u'\u2398',       # ⎘    next page
        'git': u'\uE0A0',         #     ?? private use area, font-specific
        'hg': u'\u263F',          # ☿    mercury unicode character
        'bzr': u'\u2B61\u20DF',   # ??   upwards triangle-headed arrow, combining enclosing diamond
        'fossil': u'\u2332',      # ⌲    conical taper
        'svn': u'\u2446'          # ⑆    OCR Branch Bank Identification
    }
